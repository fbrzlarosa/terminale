...
const _: () = assert!(
    std::mem::size_of::<BgFxEmitters>() == 16 + MAX_EMITTERS * 16
);
...
impl BgFxPipeline {
    ...
    pub fn upload(
        ...
        let u = BgFxUniforms {
            ...
            _pad: [0; 3],
            color1: [params.color1[0], params.color1[1], params.color1[2], band_w_f],
            color2: [params.color2[0], params.color2[1], params.color2[2], params.matrix_fall_speed],
        };
