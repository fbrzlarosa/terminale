...
impl SettingsWindow {
    pub(super) fn section_status_bar(&mut self, ui: &mut egui::Ui) {
        ...
        card(ui, |ui| {
            ...
            self.highlight_row(ui, hr.response.rect, Section::StatusBar, "Enable status bar");
            sublabel(
                ui,
        ...
        card(ui, |ui| {
            let hr = ui.horizontal(|ui| {
                ...
                let r = ui.add(
                    egui::Slider::new(
                        &mut self.config.status_bar.update_interval_ms,
                        200..=10000,
                    )
                    .suffix(" ms")
                    .text(""),
        ...
        card(ui, |ui| {
            ...
            sublabel(
                ui,
                "Segments displayed on the right side (right-aligned).",
            );
            ui.add_space(4.0);
            Self::segment_editor(
                ui,
