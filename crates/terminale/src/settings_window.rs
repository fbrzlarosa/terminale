...
impl SettingsWindow {
    ...
    pub fn sync_add_theme(&mut self, theme: terminale_config::Theme) {
        ...
        if !self.config.appearance.themes.iter().any(|t| t.name == theme.name) {
                    ...
                    .show_inside(ui, |ui| {
                        ...
                        if section_matches(Section::About, "About", "About", &tokens) {
                            ...
                            sidebar_link(
                                ...
                                &mut self.section,
                                Section::About,
                                crate::icons::glyph(ABOUT_ICON, self.config.appearance.bundled_icons),
                                "About",
                            );
                    ...
                    .show(ui, |ui| {
                        ...
                        for entry in entries {
                            ...
                            sidebar_link(
                                ...
                                &mut self.section,
                                entry.section,
                                crate::icons::glyph(entry.icon, self.config.appearance.bundled_icons),
                                entry.label,
                            );
                        }
...
fn sidebar_entries() -> &'static [SidebarEntry] {
    use crate::icons;
    &[
        SidebarEntry { group: "General",    section: Section::Profiles,         icon: &icons::FOLDER,    label: "Profiles"         },
        SidebarEntry { group: "General",    section: Section::Ssh,              icon: &icons::WORLD,     label: "SSH hosts"        },
        SidebarEntry { group: "General",    section: Section::Backup,           icon: &icons::PACKAGE,   label: "Backup"           },
        SidebarEntry { group: "Look & feel",section: Section::Appearance,       icon: &icons::PALETTE,   label: "Appearance"       },
        SidebarEntry { group: "Look & feel",section: Section::Font,             icon: &icons::TYPOGRAPHY,label: "Font"             },
        SidebarEntry { group: "Look & feel",section: Section::Cursor,           icon: &icons::EDIT,      label: "Cursor"           },
        SidebarEntry { group: "Terminal",   section: Section::Terminal,         icon: &icons::TERMINAL,  label: "Terminal"         },
        SidebarEntry { group: "Terminal",   section: Section::Window,           icon: &icons::PHOTO,     label: "Window"           },
        SidebarEntry { group: "Terminal",   section: Section::Bell,             icon: &icons::BELL,      label: "Bell"             },
        SidebarEntry { group: "Modes",      section: Section::Quake,            icon: &icons::DOWNLOAD,  label: "Quake"            },
        SidebarEntry { group: "Input",      section: Section::Shortcuts,        icon: &icons::KEY,       label: "Shortcuts"        },
        SidebarEntry { group: "Input",      section: Section::QuickSelect,      icon: &icons::SEARCH,    label: "Quick select"     },
        SidebarEntry { group: "Integrations",section: Section::Ai,             icon: &icons::AI,        label: "AI"               },
        SidebarEntry { group: "Integrations",section: Section::Plugins,        icon: &icons::PLUG,      label: "Plugins"          },
        SidebarEntry { group: "System",     section: Section::Gpu,              icon: &icons::GAMEPAD,   label: "GPU"              },
        SidebarEntry { group: "Look & feel",section: Section::StatusBar,        icon: &icons::CHART_BAR, label: "Status bar"       },
        SidebarEntry { group: "Input",      section: Section::Snippets,         icon: &icons::CLIPBOARD, label: "Snippets"         },
        SidebarEntry { group: "Terminal",   section: Section::ContextRules,     icon: &icons::TAGS,      label: "Context rules"    },
        SidebarEntry { group: "General",    section: Section::Workspaces,       icon: &icons::FLOPPY,    label: "Workspaces"       },
        SidebarEntry { group: "Input",      section: Section::ClipboardHistory, icon: &icons::FOLDER,    label: "Clipboard history"},
        SidebarEntry { group: "Input",      section: Section::DirectoryJump,    icon: &icons::MAP,       label: "Directory jump"   },
    ]
}
